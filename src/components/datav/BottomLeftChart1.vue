<template>
  <div class="bottom-left-chart-1">
    <div class="header-name">机电设备平均功率</div>
        ...
        series: [
          {
            type: 'pie',
            data: [
              { name: '天文仪器', value: 93, radius: ['30%', '33%'] },
              { name: '分析仪器', value: 65, radius: ['32%', '35%'] },
              { name: '物理测试', value: 32, radius: ['31%', '37%'] },
              { name: '海洋仪器', value: 44, radius: ['31%', '32%'] },
